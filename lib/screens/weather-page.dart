...
import 'package:weatherApp/screens/info-page.dart';
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          child: Container(
            ...
            child: Hero(
              tag: 'info-page',
              child: SvgPicture.asset('svg/info(1).svg', height: 15,width: 15,),
            ),
          ),
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => InfoCopyRight())),
        ),
        actions: <Widget>[
          InkWell(
